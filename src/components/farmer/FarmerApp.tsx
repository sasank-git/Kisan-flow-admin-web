...
export const FarmerApp: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col">
      {/* Direct Clean Container matching Admin aesthetic without phone bezel/notch */}
      <div className="w-full bg-slate-900/90 rounded-3xl border border-slate-800 shadow-xl overflow-hidden flex flex-col min-h-[720px] relative">
